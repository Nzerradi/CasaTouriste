...
public class BeachesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        locations.add(new Location(getString(R.string.beach_name_1), getString(R.string.beach_description_1), R.drawable.b1));
        locations.add(new Location(getString(R.string.beach_name_2), getString(R.string.beach_description_2), R.drawable.b2));
        locations.add(new Location(getString(R.string.beach_name_3), getString(R.string.beach_description_3), R.drawable.b3));
